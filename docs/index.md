...
| 항목 | 시기 | 배점 | 평가 방식 |
|---|---|---|---|
| ① 소규모 DB 기획하고 만들기 | 2~4주 | 20 | 20-17-14 등 3점 간격 |
| ② 논문 리뷰 | 5~7·9~12주 (총 7회) | 30 | 최저점 제외 6회만 평가. 리뷰당 5점 만점, 5-3-1 등 2점 간격 |
| ③ 미니 논증 | 13주차까지 1회 | 15 | 15-13-11-9 등 2점 간격 |

* 논문 리뷰: 미제출 시 0점. 5회 이상 제출한 경우 정상 평가. 3~4회 제출 시 10점 / 2회 이하 제출 시 5점.
* 미니 논증: 강독 대상 논문 1편을 읽고, 해당 논증을 다른 대상에 적용해 보기. A4 3매 내외.

**기말시험 20**
* 교수가 제공하는 데이터를 기반으로 사회사의 방법론과 시각으로 재해석하기.

**참여도 5**
* 모든 과제를 제출한 경우 3점 추가.
* 그 외 우수한 참여를 한 경우 2점 추가.

**출석 10**
* 출석 규정에 따라 진행.

**평가에서 고려하는 것** (개별 과제·기말시험 공통: 형식적·내용적 완성도는 기본)
* 다양한 자료를 검토·사용하는지.
...
## 제출
* 모든 과제는 이 주소에 제출한다 → <https://forms.gle/9qDjkpWd9wg7fgbX6>
* 실습: (2·3·4주): 각 주차 종료 후 
